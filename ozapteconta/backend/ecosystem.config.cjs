...
module.exports = {
  apps: [
    ...
    {
      name: "ozapteconta-worker-reserve-1",
      script: "npm",
      args: "run start:worker:reserve1",
      cwd: "/home/pc/ozapteconta/backend",
      env: {
        NODE_ENV: "production",
        ...utf8Env,
        WORKER_QUEUE: "svc_reserve_1",
        WORKER_CONCURRENCY: "1",
      },
    },
    {
      name: "ozapteconta-worker-reserve-2",
      script: "npm",
      args: "run start:worker:reserve2",
      cwd: "/home/pc/ozapteconta/backend",
      env: {
        NODE_ENV: "production",
        ...utf8Env,
        WORKER_QUEUE: "svc_reserve_2",
        WORKER_CONCURRENCY: "1",
      },
    },
    {
